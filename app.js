var t = null, e = null, a = null, i = null, n = null, r = null, o = null, s = null;

"undefined" != typeof wx && (t = require("./hj.js"), e = require("./utils/page.js"), 
a = require("./utils/request.js"), i = require("./api.js"), n = require("./utils/utils.js"), 
r = require("./commons/order-pay/order-pay.js"), o = require("./utils/uploader"), 
s = require("./utils/login.js"));
...
var u = App({
    ...
    _version: "3.0.0",
    onLaunch: function() {
        this.setApi(), i = this.api, this.getNavigationBarColor(), this.getStoreData(), 
        this.getCatList();
    },
    onShow: function(t) {
        this.onShowData = t;
    ...
    setApi: function() {
        ...
        e = e.replace("app/index.php", ""), e += "addons/zjhj_mall/core/web/index.php?store_id=-1&r=api/", 
        this.api = t(this.api);
        var a = this.api.default.index, i = a.substr(0, a.indexOf("/index.php"));
        this.webRoot = i;
    },
    webRoot: null,
    ...
    openWxapp: function(t) {
        if (t.currentTarget.dataset.url) {
            ...
            (e = function(t) {
                var e = /([^&=]+)=([\w\W]*?)(&|$|#)/g, a = /^[^\?]+\?([\w\W]+)$/.exec(t), i = {};
                if (a && a[1]) for (var n, r = a[1]; null != (n = e.exec(r)); ) i[n[1]] = n[2];
                return i;
