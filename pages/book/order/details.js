...
Page({
        ...
        wx.showLoading({
            ...
            success: function(o) {
                0 == o.code && wx.requestPayment({
                    ...
                    fail: function(o) {},
                    complete: function(o) {
                        "requestPayment:fail" != o.errMsg && "requestPayment:fail cancel" != o.errMsg ? wx.redirectTo({
                            url: "/pages/book/order/order?status=1"
                        }) : wx.showModal({
                            title: "提示",
                            content: "订单尚未支付",
    ...
    orderQrcode: function(t) {
        ...
        wx.showLoading({
            title: "正在加载",
            mask: !0
        }), a.data.goods.offline_qrcode ? (a.setData({
            hide: 0,
            qrcode: a.data.goods.offline_qrcode
        }), wx.hideLoading()) : e.request({
            url: o.book.get_qrcode,
            data: {
                order_no: a.data.goods.order_no
            },
            success: function(o) {
                0 == o.code ? a.setData({
                    hide: 0,
