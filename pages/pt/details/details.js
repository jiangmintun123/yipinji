...
var a, e = require("../../../api.js"), i = require("../../../utils.js"), o = getApp(), r = require("../../../wxParse/wxParse.js");
...
Page((a = {
    ...
    onLoad: function(t) {
        o.pageOnLoad(this);
        var a = 0, e = t.user_id, r = decodeURIComponent(t.scene);
        if (void 0 != e) a = e; else if (void 0 != r) {
            var s = i.scene_decode(r);
            s.uid && s.gid ? (a = s.uid, t.gid = s.gid) : a = r;
        }
        o.loginBindParent({
            parent_id: a
        }), this.setData({
    ...
    getGoodsInfo: function(t) {
        ...
        wx.showLoading({
            title: "正在加载",
            mask: !0
        }), wx.showNavigationBarLoading(), o.request({
            url: e.group.details,
            method: "get",
            data: {
                gid: a
            ...
            success: function(t) {
                if (0 == t.code) {
                    ...
                    r.wxParse("detail", "html", a, i), wx.setNavigationBarTitle({
    ...
    countDownRun: function(t) {
        ...
        setInterval(function() {
            var e = new Date(t[0], t[1] - 1, t[2], t[3], t[4], t[5]) - new Date(), i = parseInt(e / 1e3 / 60 / 60 / 24, 10), o = parseInt(e / 1e3 / 60 / 60 % 24, 10), r = parseInt(e / 1e3 / 60 % 60, 10), s = parseInt(e / 1e3 % 60, 10);
            i = a.checkTime(i), o = a.checkTime(o), r = a.checkTime(r), s = a.checkTime(s), 
            a.setData({
                limit_time: {
                    days: i < 0 ? "00" : i,
                    hours: o < 0 ? "00" : o,
    ...
    groupCheck: function() {
        var t = this, a = t.data.attr_group_num, i = t.data.attr_group_num.attr_list;
        for (var r in i) i[r].checked = !1;
        a.attr_list = i;
        t.data.goods;
        t.setData({
            group_checked: 0,
    ...
    attrNumClick: function(t) {
        var a = this, i = t.target.dataset.id, r = a.data.attr_group_num, s = r.attr_list;
        for (var n in s) s[n].id == i ? s[n].checked = !0 : s[n].checked = !1;
    ...
    attrClick: function(t) {
        var a = this, i = t.target.dataset.groupId, r = t.target.dataset.id, s = a.data.attr_group_list;
        for (var n in s) if (s[n].attr_group_id == i) for (var d in s[n].attr_list) s[n].attr_list[d].attr_id == r ? s[n].attr_list[d].checked = !0 : s[n].attr_list[d].checked = !1;
        a.setData({
            attr_group_list: s
        });
        var c = [], u = !0;
    ...
    setInterval(function() {
        ...
        for (var e in a) {
            var i = new Date(a[e].limit_time_ms[0], a[e].limit_time_ms[1] - 1, a[e].limit_time_ms[2], a[e].limit_time_ms[3], a[e].limit_time_ms[4], a[e].limit_time_ms[5]) - new Date(), o = parseInt(i / 1e3 / 60 / 60 / 24, 10), r = parseInt(i / 1e3 / 60 / 60 % 24, 10), s = parseInt(i / 1e3 / 60 % 60, 10), n = parseInt(i / 1e3 % 60, 10);
            o = t.checkTime(o), r = t.checkTime(r), s = t.checkTime(s), n = t.checkTime(n), 
            a[e].limit_time = {
                days: o,
                hours: r > 0 ? r : "00",
                mins: s > 0 ? s : "00",
