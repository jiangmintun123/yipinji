var t = require("../../api.js"), a = getApp(), e = 0, i = 0, o = !0, r = 1, s = "", n = !1;
...
Page({
    ...
    onLoad: function(t) {
        ...
        var e = 0, i = t.user_id, o = decodeURIComponent(t.scene);
            ...
            a.request({
                ...
                success: function(t) {
                    if (0 == t.code) {
                        var a = !1;
                        s == t.md5 && (a = !0);
                        var i = "", o = t.cha_time, r = Math.floor(o / 60 - 60 * Math.floor(o / 3600));
    ...
    showshop: function(e) {
        var i = this, o = e.currentTarget.dataset.id, r = e.currentTarget.dataset;
        a.request({
            url: t.default.goods,
            data: {
                id: o
    ...
    attrClick: function(t) {
        var a = this, e = t.target.dataset.groupId, i = t.target.dataset.id, o = a.data.attr_group_list;
        for (var r in o) if (o[r].attr_group_id == e) for (var s in o[r].attr_list) o[r].attr_list[s].attr_id == i ? o[r].attr_list[s].checked = !0 : o[r].attr_list[s].checked = !1;
        for (var n = o.length, d = 0; d < n; d++) u = (l = o[d].attr_list).length;
        for (var c = [], d = 0; d < n; d++) for (var l = o[d].attr_list, u = l.length, r = 0; r < u; r++) if (1 == l[r].checked) {
            var _ = {
                attr_id: l[r].attr_id,
        ...
        for (var h = JSON.parse(a.data.goods.attr), g = h.length, p = 0; p < g; p++) if (JSON.stringify(h[p].attr_list) == JSON.stringify(c)) var f = h[p].price;
        a.setData({
            attr_group_list: o,
            check_goods_price: f,
            check_attr_list: c
    ...
    onConfirm: function(t) {
        var a = this, e = a.data.attr_group_list, i = JSON.parse(a.data.goods.attr), o = [];
        for (var r in e) {
            i = !1;
        ...
        for (var n = a.data.check_attr_list, d = i.length, c = 0; c < d; c++) if (JSON.stringify(i[c].attr_list) == JSON.stringify(n)) var l = i[c].num;
        for (var u = wx.getStorageSync("item").quick_list, _ = a.data.goods, h = u.length, g = [], r = 0; r < h; r++) for (var p = u[r].goods, f = p.length, m = 0; m < f; m++) g.push(p[m]);
    ...
    navigatorClick: function(t) {
        ...
        return "wxapp" != a || (e = function(t) {
            ...
            if (e && e[1]) for (var o, r = e[1]; null != (o = a.exec(r)); ) i[o[1]] = o[2];
            return i;
