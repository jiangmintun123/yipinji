...
Page({
    ...
    goodsAll: function(t) {
        ...
        var o = t.currentTarget.offsetLeft, r = a.data.scrollLeft;
        r = o - 80, a.setData({
            scrollLeft: r
        }), this.list(i.id, 1), wx.createSelectorQuery().select("#catall").boundingClientRect().exec(function(t) {
            a.setData({
                height: t[0].height
            });
        });
    ...
    loadMoreGoodsList: function() {
        ...
        if (!s) {
            ...
            var c = i.data.cat_id || "", o = i.data.page || 2;
            a.request({
                url: t.default.goods_list,
                data: {
                    page: o,
