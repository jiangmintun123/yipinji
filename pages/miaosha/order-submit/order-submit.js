...
Page({
        ...
        n.data.address && n.data.address.id && (o = n.data.address.id), s.goods_info && (wx.showLoading({
            ...
            success: function(t) {
                if (wx.hideLoading(), 0 == t.code) {
                    ...
                    i.is_area = t.data.is_area, i.pay_type_list = t.data.pay_type_list, n.setData(i), 
                    n.getInputData(), 1 == t.data.send_type && n.setData({
                        offline: 0
    ...
    selectForm: function(t) {
        ...
        if ("radio" == n[e].type) {
            ...
            for (var d in o) d == i ? o[i].is_selected = 1 : o[d].is_selected = 0;
            n[e].default_list = o;
        }
