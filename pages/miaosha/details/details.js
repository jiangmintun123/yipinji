var t = require("../../../api.js"), a = require("../../../utils.js"), o = getApp(), e = require("../../../wxParse/wxParse.js"), i = 1, s = !1, r = !0, d = 0;
...
Page({
    ...
    onLoad: function(t) {
        o.pageOnLoad(this), d = 0, i = 1, s = !1, r = !0, this.setData({
            store: wx.getStorageSync("store")
        });
        var e = 0, n = t.user_id, c = decodeURIComponent(t.scene), u = 0;
        if (void 0 != n) e = n; else if (void 0 != c) {
            var _ = a.scene_decode(c);
            _.uid && _.gid ? (u = 1, e = _.uid, t.id = _.gid) : e = c;
        }
        o.loginBindParent({
            parent_id: e
        });
    ...
    submit: function(a) {
        ...
        for (var r in i) {
            var d = !1;
            for (var n in i[r].attr_list) if (i[r].attr_list[n].checked) {
                d = {
                    attr_id: i[r].attr_list[n].attr_id,
                    attr_name: i[r].attr_list[n].attr_name
                };
                break;
            }
    ...
    attrClick: function(a) {
        ...
        for (var d in r) if (r[d].attr_group_id == i) for (var n in r[d].attr_list) r[d].attr_list[n].attr_id == s ? r[d].attr_list[n].checked = !0 : r[d].attr_list[n].checked = !1;
        e.setData({
            attr_group_list: r
        });
        var c = [], u = !0;
        for (var d in r) {
            var _ = !1;
            for (var n in r[d].attr_list) if (r[d].attr_list[n].checked) {
                c.push(r[d].attr_list[n].attr_id), _ = !0;
                break;
            }
            if (!_) {
                u = !1;
