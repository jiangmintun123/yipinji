var t = require("../../api.js"), a = getApp(), e = "", i = "", s = require("../../utils/utils.js"), o = !1;
...
Page({
    ...
    onReady: function() {},
    onShow: function(t) {
        if (!getApp().onShowData || !getApp().onShowData.scene || 1034 != getApp().onShowData.scene) if (o) o = !1; else {
            getCurrentPages();
            a.pageOnShow(this);
            var e = this, i = wx.getStorageSync("picker_address");
            if (i) {
                e.data.is_area_city_id;
                var s = {};
                s.address = i, s.name = i.name, s.mobile = i.mobile, wx.removeStorageSync("picker_address"), 
                e.setData(s), e.getInputData();
            }
    ...
    getOrderData: function(s) {
        var o = this, d = {}, n = "";
        if (o.data.address && o.data.address.id && (n = o.data.address.id), d.address_id = n, 
        ...
        s.goods_info && (d.goods_info = s.goods_info), s.bargain_order_id && (d.bargain_order_id = s.bargain_order_id), 
        a.request({
            ...
            success: function(t) {
                if (wx.hideLoading(), 0 == t.code) {
                    ...
                    o.setData(a), o.getInputData(), t.data.goods_info && o.setData({
    ...
    pickCoupon: function(t) {
        ...
        wx.removeStorageSync("input_data"), "-1" == e || -1 == e ? (i.picker_coupon = !1, 
    ...
    uploadImg: function(t) {
        var e = this, i = t.currentTarget.dataset.index, s = e.data.form;
