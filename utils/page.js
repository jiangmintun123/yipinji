module.exports = {
    ...
    onLoad: function(e) {
        ...
        getApp().setNavigationBarColor(), this.setPageNavbar(e), e.naveClick = function(t) {
            ...
            i.hideLoading(e);
        }), this.setWxappImg(), void 0 === e.setTimeList && (e.setTimeList = function(e) {
    ...
    setTimeList: function(e) {
        ...
        var a = "00", i = "00", s = "00", n = 0;
        return e >= 86400 && (n = parseInt(e / 86400), e %= 86400), e < 86400 && (s = parseInt(e / 3600), 
