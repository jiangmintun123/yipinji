...
function r(e, a, i, r) {
    ...
    if (o && 0 != o.images.length) {
        ...
        try {
            for (var f, c = g.split(".")[Symbol.iterator](); !(m = (f = c.next()).done); m = !0) h += ".nodes[" + f.value + "]";
        } catch (e) {
            u = !0, v = e;
        } finally {
            try {
        ...
        var w = h + ".width", x = h + ".height";
        i.setData((d = {}, t(d, w, l.imageWidth), t(d, x, l.imageheight), d));
    }
}
...
wx.getSystemInfo({
    success: function(e) {
        s = e.screenWidth, l = e.screenHeight;
    }
}), module.exports = {
    wxParse: function() {
